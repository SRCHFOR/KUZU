...
FlowRouter.route('/show-stats', {
  name: 'showStats',
  action() {
    document.title = 'Show Stats'
    BlazeLayout.render('HomeLayout', { main: 'showStats' })
  },
})

FlowRouter.route('/show-search', {
  name: 'searchShows',
  action() {
    document.title = 'Show Search'
    BlazeLayout.render('HomeLayout', { main: 'searchShows' })
  },
})
